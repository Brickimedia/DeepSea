...
$wgResourceModules['skins.deepsea'] = array(
    'styles' => array(
        ...
        "$IP/skins/DeepSea/deepsea/screen.css" => array( 'media' => 'screen' ),
        //"$flexiblestylesheet" => array( 'media' => 'screen' ),
        "$IP/skins/DeepSea/deepsea/big.css" => array( 'media' => 'only screen and (min-width: 800px), only screen and (min-device-width: 800px)' ),
        "$IP/skins/DeepSea/deepsea/small.css" => array( 'media' => 'only screen and (max-width: 800px), only screen and (max-device-width: 800px)' ),
        "$IP/skins/DeepSea/deepsea/interactive.css" => array( 'media' => 'screen' ),
    	"$IP/skins/common/forums.css" => array( 'media' => 'screen' ),
    	//"$globalcss" => array( 'media' => 'screen' )
    	"$IP/skins/DeepSea/deepsea/projects/$bmProject.css" => array( 'media' => 'screen' )
    ),
    'scripts' => array(
    	"$IP/skins/DeepSea/deepsea/deepsea.js",
